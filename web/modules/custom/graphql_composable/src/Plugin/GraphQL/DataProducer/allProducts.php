 ...
 * )
 */
class allProducts extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function resolve($type, ?string $language, ?array $bundles, bool $access, ?AccountInterface $accessUser, ?string $accessOperation, FieldContext $context) {
    $resolver = $this->entityBuffer->add($type);
